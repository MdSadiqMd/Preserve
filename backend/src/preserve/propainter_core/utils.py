...
def create_random_shape_with_random_motion(video_length, imageHeight=240, imageWidth=432):
    ...
    # get random position
    x, y = (
        random.randint(0, imageHeight - region_height),
        random.randint(0, imageWidth - region_width),
    )
...
def create_random_shape_with_random_motion_zoom_rotation(
    video_length, zoomin=0.9, zoomout=1.1, rotmin=1, rotmax=10, imageHeight=240, imageWidth=432
):
    # get a random shape
